        ...
        foreach ($players as $player) {
            ...
            if (isset($data['ability_upgrades'])) {
                ...
                foreach($abilities_upgrade as $k=>$v) {
					...
					if ($abilities_upgrade[$k]['ability'] == "5416") { // LD true form (bear form)
						$abilities_upgrade[$k]['ability'] = "5415"; // LD true form (druid form)
					} else if ($abilities_upgrade[$k]['ability'] == "5479") { // kotl illuminate (spirit form)
						$abilities_upgrade[$k]['ability'] = "5471"; // kotl illumiate
					} else if ($abilities_upgrade[$k]['ability'] == "5510") { // troll whirling axes (melee)
						$abilities_upgrade[$k]['ability'] = "5509"; // troll whirling axes (ranged)
					} else if ($abilities_upgrade[$k]['ability'] == "5060" || $abilities_upgrade[$k]['ability'] == "5061") { // sf shadowraze 2 and 3
						$abilities_upgrade[$k]['ability'] = "5059"; // SF shadowraze 1
					} else if ($abilities_upgrade[$k]['ability'] == "5631") { // phoenix icarus dive stop
						$abilities_upgrade[$k]['ability'] = "5623"; // phoenix icarus dive
					} else if ($abilities_upgrade[$k]['ability'] == "5056") { // morphling str morph
						$abilities_upgrade[$k]['ability'] = "5054"; // morphling morph
					} else if ($abilities_upgrade[$k]['ability'] == "5055") { // morphling agi morph
						$abilities_upgrade[$k]['ability'] = "5054"; // morphling morph
					} else if ($abilities_upgrade[$k]['ability'] == "5522") { // chen test of faith (allied)
						$abilities_upgrade[$k]['ability'] = "5329"; // chen test of faith (enemy)
					}
                }
